...
public class ControllRemove implements Initializable{
    ...
    public void handleRemoveButtonAction(ActionEvent event) {
        ...
        removeData(name, phone, roomNumber, roomType, bill, date);
    ...
    private void removeData(String name, String phone, String roomNumber, String roomType, String bill, String date) {
        try {
            String query = "DELETE FROM IDCustomers WHERE Name = ? AND Phone = ? AND [Room Number] = ? AND [Room Type] = ? AND Bill = ? AND Date = ?";
